...
if("TRUE" STREQUAL "TRUE")
  set(urdf_SOURCE_PREFIX /home/odroid/catkin_ws/src/robot_model/urdf)
  set(urdf_DEVEL_PREFIX /home/odroid/catkin_ws/devel)
  set(urdf_INSTALL_PREFIX "")
  set(urdf_PREFIX ${urdf_DEVEL_PREFIX})
else()
  set(urdf_SOURCE_PREFIX "")
  set(urdf_DEVEL_PREFIX "")
  set(urdf_INSTALL_PREFIX /home/odroid/catkin_ws/install)
...
if(NOT "/home/odroid/catkin_ws/src/robot_model/urdf/include;/home/odroid/catkin_ws/devel/include;/usr/include " STREQUAL " ")
  set(urdf_INCLUDE_DIRS "")
  set(_include_dirs "/home/odroid/catkin_ws/src/robot_model/urdf/include;/home/odroid/catkin_ws/devel/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Chris Lalancette <clalancette@osrfoundation.org>, Shane Loretz <sloretz@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/odroid/catkin_ws/src/robot_model/urdf/${idir}'.  Ask the maintainer 'Chris Lalancette <clalancette@osrfoundation.org>, Shane Loretz <sloretz@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(urdf_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "urdf;/usr/lib/arm-linux-gnueabihf/liburdfdom_sensor.so;/usr/lib/arm-linux-gnueabihf/liburdfdom_model_state.so;/usr/lib/arm-linux-gnueabihf/liburdfdom_model.so;/usr/lib/arm-linux-gnueabihf/liburdfdom_world.so;/usr/lib/arm-linux-gnueabihf/libconsole_bridge.so;/usr/lib/arm-linux-gnueabihf/libboost_thread.so;/usr/lib/arm-linux-gnueabihf/libpthread.so;/usr/lib/arm-linux-gnueabihf/libtinyxml.so")
